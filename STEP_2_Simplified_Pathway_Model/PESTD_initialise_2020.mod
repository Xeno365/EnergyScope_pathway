...
#subject to elec_import_2020{i in {"ELECTRICITY"}}: sum {t in PERIODS, h in HOUR_OF_PERIOD[t], td in TYPICAL_DAY_OF_PERIOD[t]} (F_t ["YEAR_2020",i,h,td] * t_op [h, td]) = 21632;
# elec pas contrainte car en 2018 importeur d'electricité puis en 2019 exporteur grace à la bonne production du nucléaire donc bon.
